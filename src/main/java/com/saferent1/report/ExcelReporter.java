...
public class ExcelReporter {
    ...
    static String[] USER_HEADERS = {"id", "FirstName", "LastName", "PhoneNumber", "Email", "Adress",
            "ZipCode", "Roles"};
    ...
    public static ByteArrayInputStream getCarExcelReport(List<Car> cars) throws IOException {
        ...
        for (Car car : cars) {
            ...
            row.createCell(6).setCellValue(car.getAirCondition() ? "+" : "-");
            row.createCell(7).setCellValue(car.getAge());
            row.createCell(8).setCellValue(car.getPricePerHour());
            row.createCell(9).setCellValue(car.getFuel());
